      ...
      <div style={{
        ...
        >
          <div style={{
            ...
            flexWrap: 'wrap',
            width: '100%',
            height: '100%', // 确保充满 TiltCard
            boxShadow: '0 10px 30px rgba(0,0,0,0.05)',
            boxSizing: 'border-box',
            backgroundColor: colors.white // 确保背景色
          }}>
            {/* 左侧照片 */}
            <div style={{
              flex: '8',
              ...
              <div className="animate-scale-breath" style={{ width: '100%', height: '100%', position: 'absolute' }}>
                <Image 
                  src={photos.hero}
